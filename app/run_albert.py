...
pour éviter les problèmes de duplication des commandes et des instances.
"""
...
async def main():
    ...
    # Utiliser directement le point d'entrée centralisé en app/bot.py
    # pour éviter les duplications d'instances Matrix
...
if __name__ == "__main__":
    ...
    setup_logging()
    logger.info("Starting Albert Tchap via run_albert.py")
