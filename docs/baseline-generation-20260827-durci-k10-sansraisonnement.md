...
**27/08/2026.** Complète `baseline-20260827.md`.
...
**94/113** cas positifs citent au moins un article attendu.

Latence de génération : médiane **2.1 s** (min 0.5, max 10.1) sur 179 appels.

## Détail des anomalies

- **mp-005** — hors contexte : R2111-1
- **mp-008** — fantômes : L2161-1
- **mp-010** — hors contexte : L2111-2, R2111-2
- **mp-018** — hors contexte : CCAG Travaux 50
- **mp-022** — hors contexte : R2162-1
- **mp-023** — hors contexte : L2123-1, L2124-1
- **mp-031** — hors contexte : R2194-10
- **mp-037** — montants : 90 000
- **mp-038** — hors contexte : L2192-11
- **mp-045** — hors contexte : R2194-1
- **mp-047** — fantômes : R2141-1, R2141-5 · hors contexte : L2141-1, L2141-3
- **mp-048** — hors contexte : L2111-1
- **mp-077** — hors contexte : L2112-1
- **mp-078** (exécution 1) — hors contexte : L2194-1, R2194-7
- **mp-078** (exécution 2) — fantômes : L2394-1, R2394-1 · hors contexte : L2194-1
- **mp-078** (exécution 3) — hors contexte : L2194-1, R2194-7
- **mp-095** — hors contexte : L2113-5
- **mp-104** — hors contexte : R2121-1, R2181-1
- **mp-106** — hors contexte : L2122-1
- **mp-112** — hors contexte : L2124-1, R2161-1
- **mp-113** — fantômes : L3122-1 · hors contexte : L2122-1, L2124-2
- **mp-120** (exécution 2) — hors contexte : L2122-1
- **mp-127** — hors contexte : R2191-1, R2191-2
- **mp-128** — fantômes : R2192-1
