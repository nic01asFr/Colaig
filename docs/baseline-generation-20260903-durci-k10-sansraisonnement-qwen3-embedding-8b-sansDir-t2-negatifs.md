...
Latence de génération : médiane **6.0 s** (min 4.6, max 10.8) sur 66 appels.

## Détail des anomalies

- **mp-035** (exécution 3) — hors contexte : R2151-3
- **mp-080** (exécution 3) — hors contexte : L2112-1
- **mp-132** (exécution 1) — hors contexte : L2111-1
- **mp-132** (exécution 2) — fantômes : R111-2
