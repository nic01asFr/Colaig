...
Latence de génération : médiane **5.9 s** (min 4.5, max 15.3) sur 66 appels.

## Détail des anomalies

- **mp-035** (exécution 1) — fantômes : R215-1
- **mp-035** (exécution 2) — hors contexte : L2111-1, R2152-7
- **mp-035** (exécution 3) — hors contexte : R2151-1
- **mp-098** (exécution 3) — fantômes : R2113-10
- **mp-132** (exécution 1) — hors contexte : L2111-1, L2172-1
