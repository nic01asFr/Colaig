...
| | cas concernés |
|---|---|
| **Citation fantôme** — article cité inexistant dans le corpus | **2/22** |
...
Latence de génération : médiane **6.3 s** (min 4.4, max 12.5) sur 66 appels.

## Détail des anomalies

- **mp-035** (exécution 1) — fantômes : L215
- **mp-035** (exécution 2) — hors contexte : R2152-7
...
- **mp-132** (exécution 1) — hors contexte : R2111-1
- **mp-132** (exécution 2) — hors contexte : R2111-1
- **mp-132** (exécution 3) — hors contexte : R2111-1
- **mp-133** (exécution 3) — hors contexte : L2112-1
- **mp-134** (exécution 3) — hors contexte : R2171-1
