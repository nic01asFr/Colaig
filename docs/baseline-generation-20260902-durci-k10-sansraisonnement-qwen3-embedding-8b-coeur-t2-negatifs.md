...
| **Citation hors contexte** — article réel, absent des passages fournis | **6/22** |
...
Latence de génération : médiane **1.6 s** (min 0.8, max 4.5) sur 66 appels.

## Détail des anomalies

- **mp-059** (exécution 1) — hors contexte : R2111-1
- **mp-078** (exécution 1) — hors contexte : L2194-1
- **mp-078** (exécution 2) — hors contexte : L2194-1
- **mp-080** (exécution 3) — hors contexte : R2122-1
...
- **mp-133** (exécution 2) — fantômes : R2192-1, R2202-1 · hors contexte : R2162-1, R2172-1, R2182-1
