...
Latence de génération : médiane **6.0 s** (min 4.5, max 14.1) sur 66 appels.

## Détail des anomalies

- **mp-035** (exécution 1) — fantômes : R215-1, R215-2
- **mp-035** (exécution 3) — hors contexte : R2151-7, R2151-8
- **mp-062** (exécution 1) — hors contexte : L2111-1
- **mp-098** (exécution 1) — fantômes : R2113-10
- **mp-098** (exécution 2) — fantômes : R2113-10
- **mp-132** (exécution 1) — hors contexte : L2172-1
- **mp-132** (exécution 2) — hors contexte : L2111-1
- **mp-132** (exécution 3) — hors contexte : L2111-1
- **mp-133** (exécution 3) — fantômes : L2161-1
- **mp-134** (exécution 1) — hors contexte : R2171-1
