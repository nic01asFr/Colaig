...
Latence de génération : médiane **5.1 s** (min 2.4, max 12.7) sur 66 appels.

## Détail des anomalies

- **mp-035** (exécution 2) — fantômes : R215-1, R215-4
- **mp-035** (exécution 3) — fantômes : R215-1
- **mp-080** (exécution 3) — hors contexte : L2122-1, R2122-1
- **mp-097** (exécution 3) — fantômes : L26
- **mp-098** (exécution 1) — fantômes : R2113-10
- **mp-132** (exécution 1) — hors contexte : L2111-1
- **mp-132** (exécution 2) — hors contexte : L2111-1
- **mp-132** (exécution 3) — fantômes : L231-1 · hors contexte : L2111-1, R2111-1
- **mp-133** (exécution 2) — hors contexte : L2112-1
- **mp-134** (exécution 3) — hors contexte : R2162-1
