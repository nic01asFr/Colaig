...
Latence de génération : médiane **6.0 s** (min 4.6, max 14.4) sur 66 appels.

## Détail des anomalies

- **mp-035** (exécution 1) — fantômes : R215-1
- **mp-035** (exécution 2) — hors contexte : R2151-3
- **mp-062** (exécution 1) — fantômes : L211-1
- **mp-132** (exécution 1) — fantômes : L231-1 · hors contexte : L2111-1
- **mp-132** (exécution 3) — hors contexte : L2111-1
- **mp-133** (exécution 1) — hors contexte : R2112-1
- **mp-133** (exécution 3) — hors contexte : L2112-1
- **mp-134** (exécution 1) — hors contexte : L2141-1
