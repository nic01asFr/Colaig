...
Latence de génération : médiane **5.9 s** (min 4.6, max 12.1) sur 66 appels.
...
- **mp-119** (exécution 3) — hors contexte : L2152-1
- **mp-132** (exécution 2) — hors contexte : L2111-1, L2172-1
- **mp-132** (exécution 3) — hors contexte : L2111-1
- **mp-133** (exécution 1) — fantômes : L2161-1 · hors contexte : L2112-1
