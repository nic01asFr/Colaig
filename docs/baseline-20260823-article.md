...
| | cas | part |
|---|---|---|
| Tous les articles attendus remontés | **98** | 87 % |
| Partiellement remontés | 4 | 4 % |
| Aucun remonté | 11 | 10 % |

Rang du premier article attendu : médiane **1**, moyenne 1.5, max 5 (sur k=6).

Latence de recherche : médiane **0.0 ms** (min 0.0, max 109.0).
...
| mp-008 | redaction | L2113-10, R2112-1, R2122-8 | ⚠️ R2122-8 | 1 | 0.5985 |
...
| mp-019 | piege (négatif) | — | — | — | 0.491 |
| mp-020 | fait | R2122-8 | ✅ R2122-8 | 1 | 0.676 |
| mp-021 | procedure | R2191-3 | ✅ R2191-3 | 1 | 0.6369 |
...
| mp-048 | redaction | R2111-8 | ❌ — | — | 0.5804 |
...
| mp-056 | redaction | R2111-5 | ❌ — | — | 0.6277 |
...
| mp-087 | procedure | L2113-12, R2113-7 | ⚠️ L2113-12 | 1 | 0.5456 |
| mp-088 | fait | L2113-13 | ✅ L2113-13 | 1 | 0.6556 |
| mp-089 | fait | L2113-16 | ✅ L2113-16 | 1 | 0.6982 |
| mp-090 | redaction | R2113-8 | ✅ R2113-8 | 2 | 0.6742 |
...
| mp-109 | fait | R2122-9-1 | ✅ R2122-9-1 | 1 | 0.6232 |
...
| mp-121 | fait | Annexe 2 — Seuils de procédure — texte 1 | ✅ Annexe 2 — Seuils de procédure — texte 1 | 1 | 0.665 |
...
| mp-128 | redaction | CCAG Travaux 12 | ✅ CCAG Travaux 12 | 1 | 0.6677 |
| mp-129 | procedure | CCAG Travaux 3 | ✅ CCAG Travaux 3 | 5 | 0.6871 |
| mp-130 | piege (négatif) | — | — | — | 0.6663 |
| mp-131 | piege (négatif) | — | — | — | 0.6987 |
| mp-132 | piege (négatif) | — | — | — | 0.5728 |
...
- **mp-015** : attendus R2151-1 — remontés depuis 104-deuxieme-partie-marches-public, 101-deuxieme-partie-marches-public, 104-deuxieme-partie-marches-public
...
- **mp-048** : attendus R2111-8 — remontés depuis 043-ccag-techniques-de-l-informati, 019-ccag-marches-industriels-chapi, 042-ccag-techniques-de-l-informati
- **mp-051** : attendus R2111-11 — remontés depuis 097-deuxieme-partie-marches-public, 073-deuxieme-partie-marches-public, 082-deuxieme-partie-marches-public
- **mp-056** : attendus R2111-5 — remontés depuis 012-ccag-fournitures-et-services-c, 058-ccag-travaux-chapitre-6-propri, 012-ccag-fournitures-et-services-c
...
- **mp-093** : attendus L2113-4 — remontés depuis 078-deuxieme-partie-marches-public, 062-deuxieme-partie-marches-public, 078-deuxieme-partie-marches-public
...
- Embedding du corpus : **10 s** pour 1021 chunks (100 chunks/s).
