...
| | cas | part |
|---|---|---|
| Tous les articles attendus remontés | **32** | 82 % |
| Partiellement remontés | 3 | 8 % |
| Aucun remonté | 4 | 10 % |

Rang du premier article attendu : médiane **1**, moyenne 1.7, max 5 (sur k=6).

Latence de recherche : médiane **0.0 ms** (min 0.0, max 31.0).
Embedding d'une question : **11 ms** en moyenne.
...
| mp-029 | redaction | L2113-16 | ✅ L2113-16 | 1 | 0.7119 |
| mp-030 | fait | R2162-22 | ✅ R2162-22 | 1 | 0.662 |
| mp-031 | procedure | L2194-1 | ✅ L2194-1 | 2 | 0.7111 |
...
| mp-038 | procedure | L2192-12 | ✅ L2192-12 | 1 | 0.7389 |
| mp-039 | fait | L2191-4 | ✅ L2191-4 | 4 | 0.6377 |
| mp-040 | piege (négatif) | — | — | — | 0.6222 |
| mp-041 | procedure | R3124-3 | ✅ R3124-3 | 1 | 0.6284 |
| mp-042 | fait | R2191-4 | ✅ R2191-4 | 1 | 0.7276 |
| mp-043 | procedure | L2113-16 | ✅ L2113-16 | 2 | 0.6169 |
| mp-044 | piege (négatif) | — | — | — | 0.681 |
...
- **mp-022** : attendus R2182-1 — remontés depuis 157-deuxieme-partie-marches-public, 157-deuxieme-partie-marches-public, 134-deuxieme-partie-marches-public
