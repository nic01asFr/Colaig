...
Latence de génération : médiane **5.9 s** (min 4.5, max 13.1) sur 66 appels.

## Détail des anomalies

- **mp-019** (exécution 2) — hors contexte : R2143-1
- **mp-035** (exécution 1) — fantômes : R215-1
- **mp-035** (exécution 2) — fantômes : L215, R215
- **mp-035** (exécution 3) — hors contexte : R2151-7
- **mp-062** (exécution 3) — hors contexte : L2111-1, R2111-1
