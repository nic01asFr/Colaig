...
Latence de génération : médiane **6.1 s** (min 4.9, max 12.6) sur 66 appels.
...
- **mp-132** (exécution 2) — fantômes : L111-1
- **mp-132** (exécution 3) — hors contexte : R2171-1
- **mp-133** (exécution 2) — fantômes : R2192-1 · hors contexte : R2162-1, R2172-1
