...
| **Citation hors contexte** — article réel, absent des passages fournis | **2/22** |
...
Latence de génération : médiane **6.2 s** (min 4.4, max 12.4) sur 66 appels.

## Détail des anomalies

- **mp-035** (exécution 1) — fantômes : L2121-1, R215-1
- **mp-035** (exécution 2) — fantômes : R215-1
- **mp-035** (exécution 3) — fantômes : L215
...
- **mp-134** (exécution 1) — hors contexte : L2112-1
