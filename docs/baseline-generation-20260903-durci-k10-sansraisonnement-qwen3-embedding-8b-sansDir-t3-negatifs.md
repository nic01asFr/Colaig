...
| | cas concernés |
|---|---|
| **Citation fantôme** — article cité inexistant dans le corpus | **0/22** |
...
Latence de génération : médiane **5.9 s** (min 4.7, max 10.9) sur 66 appels.

## Détail des anomalies

- **mp-035** (exécution 1) — hors contexte : R2151-7
- **mp-035** (exécution 2) — hors contexte : R2152-7
- **mp-035** (exécution 3) — hors contexte : L2151-1, R2151-1
...
- **mp-133** (exécution 1) — hors contexte : L2111-1
