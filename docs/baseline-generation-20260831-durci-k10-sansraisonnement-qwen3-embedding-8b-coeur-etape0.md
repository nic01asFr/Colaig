...
| | cas concernés |
|---|---|
| **Citation fantôme** — article cité inexistant dans le corpus | **4/135** |
...
**100/113** cas positifs citent au moins un article attendu.

Latence de génération : médiane **2.0 s** (min 0.5, max 6.4) sur 179 appels.

## Détail des anomalies

- **mp-023** — hors contexte : R2122-1
- **mp-034** — hors contexte : L2111-1, L2123-1, L2191-1, R2191-1 · montants : 80 000
- **mp-035** (exécution 2) — hors contexte : L2151-1
- **mp-039** — fantômes : R2191-19
- **mp-048** — hors contexte : L2111-1, R2111-1
- **mp-049** — hors contexte : L2111-1, R2111-14
- **mp-052** — fantômes : L2111-4
- **mp-056** — fantômes : L131-1
- **mp-066** — hors contexte : L2112-1
- **mp-068** — hors contexte : L2111-1
- **mp-078** (exécution 1) — hors contexte : L2194-1
- **mp-079** (exécution 1) — hors contexte : L2194-1, L2194-2
- **mp-088** — hors contexte : R2113-1
- **mp-107** — hors contexte : L2122-1
- **mp-113** — hors contexte : R2124-5
- **mp-114** — hors contexte : L2124-3
- **mp-130** (exécution 1) — hors contexte : R2192-30
- **mp-130** (exécution 2) — hors contexte : R2192-34
- **mp-130** (exécution 3) — fantômes : R2192-1
- **mp-132** (exécution 1) — hors contexte : L2111-1
- **mp-132** (exécution 2) — hors contexte : L2111-1
- **mp-132** (exécution 3) — hors contexte : L2111-1
- **mp-133** (exécution 3) — hors contexte : R2152-1
